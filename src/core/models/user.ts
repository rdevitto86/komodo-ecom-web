import PriorityQueue from '../../auxiliary/util/data-structures/priority-queue';
...
export class User {
    ...
    /**
     * @private
     * @property {PriorityQueue} _orders
     * @description user invoice history
     */
    private _orders: PriorityQueue<Order> = new PriorityQueue();
     ...
     */
    get type() {
        return ACCT_TYPES[this._type] || 'N/A';
    }

    /**
     * @public
     * @readonly
     * @property {PriorityQueue<OrderInvoice>} invoices
     * @description user invoice history
     */
    get invoices() {
        return this._orders;
