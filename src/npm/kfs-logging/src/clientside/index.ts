import { LogLevels, LogPriorities } from '..';
import { Message, Exception } from '../types/logs';
...
export class ClientLogger {
     ...
     */
    static fatal(log: Exception | string) {
     ...
     * @param {Exception | string} log error information
     */
    static error(log: Exception | string) {
     ...
     * @param {Exception | string} log error information
     */
    static warn(log: Exception | string) {
 ...
 * @private
 * @param {Message} log log message properties
 */
const _processLog = (ENABLE_LOGGER) ? (log: Message) => {
    try {
        const {
            level,
            message,
 ...
 * @private
 * @param {string} level log level
 * @param {Exception | string} log exception information
 */
