 ...
 * @class
 * @version 1.0
 * @description collection of utlity functions that assists with math and number operations
 */
export default class NumberUtil {
    /**
     * @public
     * @static
     * @function NumberUtil.add
     ...
     * @public
     * @static
     * @function NumberUtil.percentDecimal
     ...
     * @public
     * @static
     * @function NumberUtil.percentWhole
     ...
     * @public
     * @static
     * @function NumberUtil.convertMilliseconds
     ...
     */
    static convertMilliseconds(milliseconds: number | string) {
     ...
     * @public
     * @static
     * @function NumberUtil.tranformDays
     ...
     * @returns {Object} calculated time units
     */
    static convertDays(days: number | string) {
     ...
     * @public
     * @static
     * @function NumberUtil.calculateTimeDifference
    ...
    static calculateTimeDifference(recent: Date, previous: Date) {
        ...
        return {
            ...this.convertMilliseconds(milliseconds),
