 ...
 */
export const PRIVACY_NOTICE_PART1 = `We at Komodo believe in transparency when it comes to our customers' privacy.
 ...
 */
export const PRIVACY_NOTICE_PART2 = `You can learn more about JavaScript Web APIs at: https://developer.mozilla.org/en-US/docs/Web/API/Navigator
