 ...
 * @public
 * @readonly
 * @constant {Object<AccountType>} ACCT_TYPES
...
export interface UserAbstract {
    ...
    // address details
    address?: Address | AddressAbstract;

    // business details
    company?: Company | CompanyAbstract;

    // billing details
    billing?: Billing | BillingAbstract;
...
export class User implements UserAbstract {
     ...
     * @description builds a name string for the current user
     * @returns {String} the user's full name (ex. John Smith, Sr.)
     */
    formatName(): string {
